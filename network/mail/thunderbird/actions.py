...
def setup():    
    ...
    shelltools.system("echo -n 'AIzaSyDwr302FpOSkGRpLlUpPThNTDPbXcIn_FM' >google-api-key")
    shelltools.system("echo -n '16674381-f021-49de-8622-3021c5942aff' >mozilla-api-key")
