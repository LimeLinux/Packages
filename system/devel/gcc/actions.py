...
def setup():
    ...
    shelltools.system('../configure \
                       ...
                       --with-bugurl=http://bugs.limelinux.com' % get.HOST())
...
def install():
    ...
    """
    removeLimeSection("%s/usr/lib/" % get.installDIR())
    if get.ARCH() == "x86_64":
        removeLimeSection("%s/usr/lib32/" % get.installDIR())
    """
